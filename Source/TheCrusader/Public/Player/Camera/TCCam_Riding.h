...
#include "TCCam_ThirdPerson.h"
#include "Character/Movement/TCRidingState.h"
#include "TCCam_Riding.generated.h"

/**
 * 
 */
UCLASS()
class THECRUSADER_API UTCCam_Riding : public UTCCam_ThirdPerson
{
	GENERATED_BODY()

public:
#pragma region TCCameraMode Interface
	virtual void UpdateCamera(class AActor* ViewTarget, UCineCameraComponent* CineCamComp, float DeltaTime,
	                          struct FTViewTarget& OutVT) override;
...
#pragma endregion TCCameraModeInterface

protected:
#pragma region TCCam_ThirdPerson Interface
	...
	virtual void
	ComputePredictiveLookAtPoint(FVector& LookAtPointOutput, const AActor* ViewTarget, float DeltaTime) override final;
...
#pragma endregion TCCam_ThirdPerson Interface
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Driving Camera Adjustments|FOV",
		meta = (EditCondition = bUseFOVSpeedAdjustmentCurve))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Driving Camera Adjustments|Yaw",
		meta = (EditCondition = bUseSteeringYawModifiers))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Driving Camera Adjustments|Roll",
		meta = (EditCondition = bUseSteeringRollModifiers))
