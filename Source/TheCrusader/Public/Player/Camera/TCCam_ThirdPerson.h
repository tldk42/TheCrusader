...
#include "TCCam_ThirdPerson.generated.h"
...
class THECRUSADER_API UTCCam_ThirdPerson : public UTCCameraMode
{
	GENERATED_BODY()
...
#pragma endregion UTCCameraMode
...
*/
	virtual void PreventCameraPenetration(AActor* Target, TArray<FPenetrationAvoidanceRay>& Rays,
	                                      const FVector& SafeLoc, const FVector& IdealCameraLoc, float DeltaTime,
	                                      FVector& OutCameraLoc, float& DistBlockedPct, bool bPrimaryRayOnly = false);
